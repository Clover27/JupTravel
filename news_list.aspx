...
<asp:Content ID="Content2" ContentPlaceHolderID="body" Runat="Server">
    ...
    <asp:DataList ID="DataList1" runat="server" DataKeyField="id" DataSourceID="SqlDataSource1" CellPadding="4" ForeColor="#333333" Width="624px" ItemStyle-HorizontalAlign="Left">
